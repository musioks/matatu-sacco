...
--
-- Host: localhost:3306
-- Generation Time: Nov 06, 2017 at 10:35 AM
...
INSERT INTO `bookings` (`id`, `name`, `phone`, `email`, `destination`, `event_date`, `created_at`, `updated_at`) VALUES
(1, 'john kiarie', '0712744255', 'myk@gmail.com', 'Kampala', '06/12/2017', '2017-11-06 04:34:07', '2017-11-06 04:34:07');
...
CREATE TABLE `loans` (
  `id` int(10) UNSIGNED NOT NULL,
  `member_id` int(10) UNSIGNED NOT NULL,
  `date_applied` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `loan_applications` (
  ...
  `guarantor_status` tinyint(1) NOT NULL DEFAULT '0',
  `guarantor_reason` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_reason` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, '2017_10_22_072027_create_loans_table', 1),
(5, '2017_10_22_072044_create_shares_table', 1),
(6, '2017_10_22_072108_create_insurances_table', 1),
(7, '2017_10_22_072204_create_vehicles_table', 1),
(8, '2017_10_22_072223_create_bookings_table', 1),
(9, '2017_10_22_072246_create_complains_table', 1),
(10, '2017_10_22_072310_create_products_table', 1),
(11, '2017_11_04_125439_create_loan_applications_table', 1);
...
CREATE TABLE `vehicles` (
  ...
  `image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'matatu.png',
  `price` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `loan_applications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `loan_applications_member_id_foreign` (`member_id`);
...
ALTER TABLE `vehicles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `vehicles_reg_no_unique` (`reg_no`);
...
--
ALTER TABLE `loan_applications`
  ADD CONSTRAINT `loan_applications_member_id_foreign` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
