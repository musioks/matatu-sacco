                                        ...
                                        <div class="col-sm-6">
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <hr>
                                                    <h5> Model : {{$bus->model ?? ''}} <em
                                                            class="pull-right text-warning">Capacity
                                                            : {{$bus->capacity ?? ''}}  </em></h5>
                                                    <hr>
                                                    Amount Per Day: <span
                                                        class="label label-danger"
                                                        style="padding: 8px;"> Kshs.{{number_format($bus->booking_amount)}}</span>
                                                    <p> {{$bus->description ?? ''}}</p>
                                                    @if($user = Sentinel::check())
                                                    ...
                                                    @else
                                                        <button class="btn btn-success" data-toggle="modal"
                                                                data-target="#signup"><i class="fa fa-pencil"></i>
                                                            SignUp
                                                        </button>
                                                    @endif
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form" method="POST" action="{{url('/hire-bus')}}">
                                                            ...
                                                            <input type="hidden" name="customer_id" value="{{\App\Customer::where('user_id',$user->id)->first()->id}}">
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="row">
                                                                    <div class="col-md-8 col-md-offset-2">
                                                                        <button
                                                                            class="btn btn-success icon-btn btn-block"
                                                                            type="submit"><i
