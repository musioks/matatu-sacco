...
@section('page_name') <i class="fa fa-fw fa-dashboard"></i>My Insurance @stop
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" method="POST" action="{{url('/member/insurance')}}"
                    ...
                    <table class="table table-hover table-bordered table-condensed">
                        ...
                        <tbody>
                        @forelse(\App\Helpers\GeneralHelper::insurances() as $r)
                            <tr>
