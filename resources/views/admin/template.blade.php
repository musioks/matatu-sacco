...
<link href="{{asset('css/font-awesome.min.css')}}" rel="stylesheet">
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="{{ route('dashboard') }}"><h5 style="font-family: sans-serif;"> MATATU SACCO SYSTEM</h5></a>
            ...
            <ul class="top-nav">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg fa-fw "></i>{{Sentinel::getUser()->name}}</a>
                <ul class="dropdown-menu settings-menu">
                  <li><a href="" data-toggle="modal" data-target="myModal"><i class="fa fa-user fa-lg"></i> Profile</a></li>
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="{{route('members')}}"><i class="fa fa-user"></i><span>Members</span></a></li>
            <li><a href="{{route('users')}}"><i class="fa fa-users"></i><span>Users</span></a></li>
            <li><a href="{{route('admin_loan')}}"><i class="fa fa-life-ring"></i><span>Approve Loans</span></a></li>
            <li><a href="{{route('shares')}}"><i class="fa fa-shopping-bag"></i><span>Check Shares</span></a></li>
        ...
        <div class="modal-body">
          <form>
            <div class="form-group">
              ...
              <input type="email" class="form-control" value="{{}}" id="exampleInputEmail1" placeholder="Email">
            </div>
            <div class="form-group">
