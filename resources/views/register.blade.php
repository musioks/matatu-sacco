            ...
            <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('nid') ? ' has-error' : '' }}">
                                        <input class="form-control" placeholder="National ID" name="nid" type="number"
              ...
              <strong>{{ $errors->first('nid') }}</strong>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('dob') ? ' has-error' : '' }}">
                                        <input class="form-control" placeholder="Date of Birth" name="dob" id="demoDate"
                                               type="text" autofocus>
                                        @if ($errors->has('dob'))
                                            <span class="help-block">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group {{ $errors->has('residence') ? ' has-error' : '' }}">
                                        <input class="form-control" placeholder="Where do you stay?" name="residence"
                                               type="text" value="{{old('residence')}}" autofocus>
              ...
              <strong>{{ $errors->first('password') }}</strong>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <button class="btn btn-primary icon-btn btn-block" type="submit"><i
